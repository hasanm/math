...
\begin{problem*}
 5-30  Prove that
  ...
  \end{enumerate}
% 
%   (These equations, and others like them, are open to several
%   interpretations. They might mean only that the two limits are equal if they
%   both exist; or that if a certain one of the limits exists, the other also
%   exists and is equal to it; or that if either limit exists, then the other
%   exists and is equal to it. Decide for yourself which interpretations are
%   suitable).
\end{problem*}
